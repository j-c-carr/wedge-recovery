...
class ModelManager:
    ...
    def __init__(self, 
        ...
        :ID:              Model id with format: <name>_datetime
        :params:          Dictionary for model params, loaded from yml file
        :LIGHTCONE_SHAPE: Shape of a single training sample
        ...
        assert X.shape[1:] == LIGHTCONE_SHAPE and Y.shape[1:] == LIGHTCONE_SHAPE, \
               f"Model expects samples of shape {LIGHTCONE_SHAPE}" + \
    ...
    def initialize_model(self,
        ...
        input_img = Input((*self.LIGHTCONE_SHAPE, 1), name='img')
    ...
    def predict_on(self,
        ...
        ----------
        Params:
        :threshold: Cutoff value for creating binary predictions
        :X:         Lightcones to predict on
        :Y:         Labels to compare with predictions
        """
